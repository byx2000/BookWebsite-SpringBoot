    ...
    let app = new Vue(
    {
        ...
        methods:
        {
            ...
            lastPage: function()
            {
                ...
                {
                    request(COMMENT_QUERY_OF_BOOK_URL, { bookId: this.bookId, pageSize: 10, currentPage: app.currentPage - 1 })
                        .then(pageBean =>
                        {
            ...
            {
                request(COMMENT_QUERY_OF_BOOK_URL, { bookId: this.bookId, pageSize: 10, currentPage: page })
                    .then(pageBean =>
                    {
                        app.commentsAndBooks = pageBean.data;
                        app.totalCount = pageBean.totalCount;
        ...
        mounted: function()
        {
            ...
            // 获取评论
            request(COMMENT_QUERY_OF_BOOK_URL, { bookId: this.bookId, pageSize: 10, currentPage: this.currentPage })
                .then(pageBean =>
                {
                    app.commentsAndBooks = pageBean.data;
                    app.totalCount = pageBean.totalCount;
